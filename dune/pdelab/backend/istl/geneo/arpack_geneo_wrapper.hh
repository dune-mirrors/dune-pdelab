...
// copy-paste from Peter Bastian ftworth module
...
namespace ArpackMLGeneo
{
  ...
  public:
                                              ...
                                              std::vector<BlockVector>& x, std::vector<Real>& lambda, Real sigma) const
    {
      ...
      // Solve problem as a standard EV problem with own shift_invert
      ARNonSymGenEig<Real,WrappedMatrix,WrappedMatrix> dprob(nrows, nev, &A, &WrappedMatrix::multMv, &A, &WrappedMatrix::multMvB, sigma, which, ncv, tol, maxit);
