...
#ifndef DUNE_PDELAB_TRANSFORM_TREE_HH
#define DUNE_PDELAB_TRANSFORM_TREE_HH
...
namespace Dune::PDELab {
     ...
     *
     * \note The specialization does not have to placed in the namespace Dune::PDELab,
    ...
    struct TransformTree<S,T,Dune::TypeTree::LeafNodeTag,recursive>
    {
    ...
    namespace Impl {
      ...
      class RecursivePowerTransformTree
      {
        ...
        static_assert(std::is_same_v<Tag,Dune::TypeTree::PowerNodeTag> or std::is_same_v<Tag,Dune::TypeTree::DynamicPowerNodeTag>);
    ...
    struct TransformTree<Source,Transformation,Dune::TypeTree::PowerNodeTag,true>
      : public Impl::RecursivePowerTransformTree<Source,Transformation,Dune::TypeTree::PowerNodeTag>
    {};

    // Recursive version of the DynamicPowerNode transformation for static nodes.
    template<typename Source, typename Transformation>
    struct TransformTree<Source,Transformation,Dune::TypeTree::DynamicPowerNodeTag,true>
      : public Impl::RecursivePowerTransformTree<Source,Transformation,Dune::TypeTree::DynamicPowerNodeTag>
    {};

    // non-recursive version of the PowerNode transformation.
    template<typename S, typename T>
    struct TransformTree<S,T,Dune::TypeTree::PowerNodeTag,false>
      : public TransformTreeNonRecursive<S,T>
    {};

    // non-recursive version of the DynamicPowerNodeTag transformation.
    template<typename S, typename T>
    struct TransformTree<S,T,Dune::TypeTree::DynamicPowerNodeTag,false>
      : public TransformTreeNonRecursive<S,T>
    {};
    ...
    template<typename S, typename T>
    struct TransformTree<S,T,Dune::TypeTree::CompositeNodeTag,true>
    {
    ...
    template<typename S, typename T>
    struct TransformTree<S,T,Dune::TypeTree::CompositeNodeTag,false>
      : public TransformTreeNonRecursive<S,T>
    {};
...
#endif // DUNE_PDELAB_TRANSFORM_TREE_HH
